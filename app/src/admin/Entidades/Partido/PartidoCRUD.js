        ...
        <div className="PartidoSection">
          <div className="ParejaPartido">
            <div className="JugadorPartido">
              ...
              />
              <h4>{p1jugador1.nombre + " " + p1jugador1.apellidos}</h4>
            </div>
            <div className="JugadorPartido">
              <img
                ...
                className="BanderaPais"
              />
              <h4>{p1jugador2.nombre + " " + p1jugador2.apellidos}</h4>
            </div>
          </div>
          ...
          <div className="ParejaPartido">
            ...
            <div className="JugadorPartido">
              <img
                ...
                className="BanderaPais"
              />
              <h4>{p2jugador2.nombre + " " + p2jugador2.apellidos}</h4>
            </div>
          </div>
          <div className="Resultados">
            <h1>{resultado[1]}</h1>
